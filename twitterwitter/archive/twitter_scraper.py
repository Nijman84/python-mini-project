...
import requests
# Connection Unsuccessfulimport os
import json
import numpy as np
import sys
...
class TwitterScraper:
    ...
    def get_data(self, screen_name, record_no, json_path):
        ...
        max_id = None
        data_list = []
        auth = requests_oauthlib.OAuth1(self.api_key, self.api_secret, self.access_token, self.access_token_secret)
    ...
    def create_user_table(self, data_list, file_path):
        ...
        .format(follow_request_sent, has_extended_profile, profile_use_background_image, default_profile_image,
                ...
                profile_link_color, profile_image_url, following, geo_enabled, profile_background_image_url,
