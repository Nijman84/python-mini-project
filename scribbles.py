...
parser = argparse.ArgumentParser(description='Tell me 3 things, the last being your favourite number...')
parser.add_argument('first_thing', type=str, help='1st ting')
parser.add_argument('second_thing', type=str, help='2nd ting')
parser.add_argument('third_thing', type=int, help='3rd ting, integer')
